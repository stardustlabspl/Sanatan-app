...
class AstroSignUP extends StatefulWidget {
  const AstroSignUP({super.key});

  @override
  State<AstroSignUP> createState() => _AstroSignUPState();
}

class _AstroSignUPState extends State<AstroSignUP> {
  @override
        ...
        body: SafeArea(
          child: Stack(children: [
            ...
            PositionedText(
              ...
              width: width,
              label: AppStrings.astroSignUpWelcome,
              bottom: 320,
